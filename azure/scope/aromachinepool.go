...
func (s *AROMachinePoolScope) UpdateDeleteStatus(condition string, service string, err error) {
	switch {
	case err == nil:
...
func (s *AROMachinePoolScope) UpdatePutStatus(condition string, service string, err error) {
	switch {
	case err == nil:
		conditions.Set(s.InfraMachinePool, metav1.Condition{
			Type:   condition,
...
func (s *AROMachinePoolScope) UpdatePatchStatus(condition string, service string, err error) {
	switch {
	case err == nil:
		conditions.Set(s.InfraMachinePool, metav1.Condition{
			Type:   condition,
