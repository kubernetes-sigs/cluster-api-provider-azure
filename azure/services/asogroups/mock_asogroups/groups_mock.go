...
// Package mock_asogroups is a generated GoMock package.
...
// ASOGroupSpec mocks base method.
func (m *MockGroupScope) ASOGroupSpec() azure.ASOResourceSpecGetter {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ASOGroupSpec")
	ret0, _ := ret[0].(azure.ASOResourceSpecGetter)
	return ret0
}

// ASOGroupSpec indicates an expected call of ASOGroupSpec.
func (mr *MockGroupScopeMockRecorder) ASOGroupSpec() *gomock.Call {
