...
func (m *MockNSGScope) AdditionalTags() v1alpha4.Tags {
	m.ctrl.T.Helper()
...
func (m *MockNSGScope) CloudProviderConfigOverrides() *v1alpha4.CloudProviderConfigOverrides {
	m.ctrl.T.Helper()
...
func (m *MockNSGScope) ControlPlaneRouteTable() v1alpha4.RouteTable {
	m.ctrl.T.Helper()
...
func (m *MockNSGScope) NodeNatGateway() v1alpha4.NatGateway {
	m.ctrl.T.Helper()
...
func (mr *MockNSGScopeMockRecorder) NodeNatGateway() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "NodeNatGateway", reflect.TypeOf((*MockNSGScope)(nil).NodeNatGateway))
}

// NodeRouteTable mocks base method.
func (m *MockNSGScope) NodeRouteTable() v1alpha4.RouteTable {
	m.ctrl.T.Helper()
...
// V mocks base method.
func (m *MockNSGScope) V(level int) logr.Logger {
	m.ctrl.T.Helper()
...
func (m *MockNSGScope) Vnet() *v1alpha4.VnetSpec {
	m.ctrl.T.Helper()
