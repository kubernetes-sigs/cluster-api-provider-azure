...
func (m *MockScope) AdditionalTags() v1beta2.Tags {
	m.ctrl.T.Helper()
...
func (m *MockScope) CloudProviderConfigOverrides() *v1beta2.CloudProviderConfigOverrides {
	m.ctrl.T.Helper()
...
func (m *MockScope) ExtendedLocation() *v1beta2.ExtendedLocationSpec {
	m.ctrl.T.Helper()
