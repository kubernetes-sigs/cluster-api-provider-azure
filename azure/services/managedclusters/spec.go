...
func (s *ManagedClusterSpec) buildManagedClusterOperatorSpec(managedCluster *asocontainerservicev1.ManagedCluster) {
...
func (s *ManagedClusterSpec) buildManagedClusterSecurityProfile(managedCluster *asocontainerservicev1.ManagedCluster) {
...
func (s *ManagedClusterSpec) buildManagedClusterLinuxSSHProfile(managedCluster *asocontainerservicev1.ManagedCluster) error {
...
func (s *ManagedClusterSpec) buildManagedClusterAPIServerAccessProfile(managedCluster *asocontainerservicev1.ManagedCluster) {
...
func (s *ManagedClusterSpec) buildManagedClusterHTTPProxyConfig(managedCluster *asocontainerservicev1.ManagedCluster) {
...
func convertV1ToPreview(managedCluster *asocontainerservicev1.ManagedCluster) (*asocontainerservicev1preview.ManagedCluster, error) {
	...
	if err := preview.ConvertFrom(hub); err != nil {
		return nil, err
	}
	return preview, nil
}
...
func (s *ManagedClusterSpec) stashPreview(existingObj genruntime.MetaObject) (*asocontainerservicev1preview.ManagedCluster, 
	func(*asocontainerservicev1preview.ManagedCluster) (*asocontainerservicev1.ManagedCluster, error),
	func(*asocontainerservicev1.ManagedCluster) (*asocontainerservicev1preview.ManagedCluster, error)) {
	
	if existingObj == nil {
		return nil, convertPreviewToV1, convertV1ToPreview
	}	
	
	return existingObj.(*asocontainerservicev1preview.ManagedCluster), convertPreviewToV1, convertV1ToPreview
}

func (s *ManagedClusterSpec) prepare(existingObj genruntime.MetaObject) ( *asocontainerservicev1.ManagedCluster) {
	if existingObj != nil {
		return existingObj.(*asocontainerservicev1.ManagedCluster)
	} 
	return &asocontainerservicev1.ManagedCluster{
...
func (s *ManagedClusterSpec) Parameters(ctx context.Context, existingObj genruntime.MetaObject) (params genruntime.MetaObject, err error) {
	...
	var previewManagedCluster *asocontainerservicev1preview.ManagedCluster
	var previewResponseHandler func(*asocontainerservicev1.ManagedCluster) (*asocontainerservicev1preview.ManagedCluster, err)
	var managedCluster *asocontainerservicev1.ManagedCluster
	
	if s.Preview {	
	// there is an existing object, convert it to the desired type
		previewManagedCluster, convertPreviewToV1, previewResponseHandler = s.stashPreview(existingObj)
		managedCluster, err = convertPreviewToV1(previewManagedCluster)
		if err != nil {
			return nil, err
		}
	} 
	if (managedCluster == nil) {
		managedCluster = s.prepare(existingObj)
	}
	...
	s.buildManagedClusterVersion(managedCluster)
	err = s.buildManagedClusterNetworkProfile(managedCluster)
	if err != nil {
	...
	s.buildManagedClusterOperatorSpec(managedCluster)

	err = s.buildManagedClusterLinuxSSHProfile(managedCluster)
	if err != nil {
		return nil, err
	}
	...
	s.buildManagedClusterAPIServerAccessProfile(managedCluster)
	...
	s.buildManagedClusterHTTPProxyConfig(managedCluster)
	...
	s.buildManagedClusterSecurityProfile(managedCluster)
	...
	if managedCluster.Status.AgentPoolProfiles == nil {
		...
		for _, agentPoolSpec := range agentPoolSpecs {
			...
			if s.Preview {
				...
				previewManagedCluster.Spec.AgentPoolProfiles = append(previewManagedCluster.Spec.AgentPoolProfiles, profile)
			} else {
	...
	params, err = s.teardown(previewManagedCluster, managedCluster)
