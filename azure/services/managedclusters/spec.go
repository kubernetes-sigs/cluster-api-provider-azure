...
func (s *ManagedClusterSpec) buildManagedClusterNetworkProfile() (*asocontainerservicev1.ContainerServiceNetworkProfile, error) {
...
func (s *ManagedClusterSpec) buildManagedClusterOperatorSpec() *asocontainerservicev1.ManagedClusterOperatorSpec {
...
func (s *ManagedClusterSpec) buildManagedClusterSecurityProfile() *asocontainerservicev1.ManagedClusterSecurityProfile {
...
func (s *ManagedClusterSpec) buildManagedClusterLinuxSSHProfile() (*asocontainerservicev1.ContainerServiceLinuxProfile, error) {
...
func (s *ManagedClusterSpec) buildManagedClusterAPIServerAccessProfile() *asocontainerservicev1.ManagedClusterAPIServerAccessProfile {
...
func (s *ManagedClusterSpec) buildManagedClusterHTTPProxyConfig() *asocontainerservicev1.ManagedClusterHTTPProxyConfig {
...
func (s *ManagedClusterSpec) Parameters(ctx context.Context, existingObj genruntime.MetaObject) (params genruntime.MetaObject, err error) {
	...
	managedCluster.Spec.ApiServerAccessProfile = s.buildManagedClusterAPIServerAccessProfile()
	...
	managedCluster.Spec.HttpProxyConfig = s.buildManagedClusterHTTPProxyConfig()
	...
	managedCluster.Spec.SecurityProfile = s.buildManagedClusterSecurityProfile()
