...
func (m *MockLBScope) AzureClusterIdentity() *v1beta1.AzureClusterIdentity {
	m.ctrl.T.Helper()
...
func (mr *MockLBScopeMockRecorder) AzureClusterIdentity() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "AzureClusterIdentity", reflect.TypeOf((*MockLBScope)(nil).AzureClusterIdentity))
}
