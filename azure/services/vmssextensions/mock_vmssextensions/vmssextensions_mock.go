...
func (m *MockVMSSExtensionScope) SecureBootstrapEnabled() bool {
	m.ctrl.T.Helper()
...
func (mr *MockVMSSExtensionScopeMockRecorder) SecureBootstrapEnabled() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SecureBootstrapEnabled", reflect.TypeOf((*MockVMSSExtensionScope)(nil).SecureBootstrapEnabled))
}
