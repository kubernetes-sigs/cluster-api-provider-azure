...
func (m *MockScaleSetScope) AzureClusterIdentity() *v1beta1.AzureClusterIdentity {
	m.ctrl.T.Helper()
...
func (mr *MockScaleSetScopeMockRecorder) AzureClusterIdentity() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "AzureClusterIdentity", reflect.TypeOf((*MockScaleSetScope)(nil).AzureClusterIdentity))
}
