...
func (m *MockInboundNatScope) SecureBootstrapEnabled() bool {
	m.ctrl.T.Helper()
...
func (mr *MockInboundNatScopeMockRecorder) SecureBootstrapEnabled() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SecureBootstrapEnabled", reflect.TypeOf((*MockInboundNatScope)(nil).SecureBootstrapEnabled))
}
