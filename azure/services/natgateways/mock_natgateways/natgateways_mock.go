...
func (m *MockNatGatewayScope) SecureBootstrapEnabled() bool {
	m.ctrl.T.Helper()
...
func (mr *MockNatGatewayScopeMockRecorder) SecureBootstrapEnabled() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SecureBootstrapEnabled", reflect.TypeOf((*MockNatGatewayScope)(nil).SecureBootstrapEnabled))
}
