...
func TestReconcilePublicIP(t *testing.T) {
	testcases := []struct {
		...
		expect        func(s *mock_publicips.MockPublicIPScopeMockRecorder, m *mock_asyncpoller.MockTagsGetterMockRecorder, r *mock_asyncpoller.MockReconcilerMockRecorder)
	}{
		{
