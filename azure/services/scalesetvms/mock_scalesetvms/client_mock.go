...
func (m *Mockclient) GetResultIfDone(ctx context.Context, future *v1alpha3.Future) (compute.VirtualMachineScaleSetVM, error) {
	m.ctrl.T.Helper()
...
func (m *Mockclient) DeleteAsync(arg0 context.Context, arg1, arg2, arg3 string) (*v1alpha3.Future, error) {
	m.ctrl.T.Helper()
