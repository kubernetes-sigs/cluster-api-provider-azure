...
func (m *MockNICScope) SecureBootstrapEnabled() bool {
	m.ctrl.T.Helper()
...
func (mr *MockNICScopeMockRecorder) SecureBootstrapEnabled() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SecureBootstrapEnabled", reflect.TypeOf((*MockNICScope)(nil).SecureBootstrapEnabled))
}
