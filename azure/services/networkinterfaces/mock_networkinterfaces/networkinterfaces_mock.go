...
func (m *MockNICScope) AdditionalTags() v1alpha4.Tags {
	m.ctrl.T.Helper()
...
func (m *MockNICScope) CloudProviderConfigOverrides() *v1alpha4.CloudProviderConfigOverrides {
	m.ctrl.T.Helper()
...
// V mocks base method.
func (m *MockNICScope) V(level int) logr.Logger {
	m.ctrl.T.Helper()
