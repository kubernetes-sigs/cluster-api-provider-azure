...
func (m *MockGroupScope) AzureClusterIdentity() *v1beta1.AzureClusterIdentity {
	m.ctrl.T.Helper()
...
func (mr *MockGroupScopeMockRecorder) AzureClusterIdentity() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "AzureClusterIdentity", reflect.TypeOf((*MockGroupScope)(nil).AzureClusterIdentity))
}
