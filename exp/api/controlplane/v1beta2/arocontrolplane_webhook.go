...
func SetupAROControlPlaneWebhookWithManager(mgr ctrl.Manager) error {
	...
	return ctrl.NewWebhookManagedBy(mgr, &AROControlPlane{}).
		WithDefaulter(mw).
		WithValidator(mw).
		Complete()
}
...
func (mw *aroControlPlaneWebhook) Default(_ context.Context, _ *AROControlPlane) error {
	return nil
}
...
func (mw *aroControlPlaneWebhook) ValidateCreate(_ context.Context, m *AROControlPlane) (admission.Warnings, error) {
	return nil, m.Validate(mw.Client)
}

// ValidateUpdate implements webhook.Validator so a webhook will be registered for the type.
func (mw *aroControlPlaneWebhook) ValidateUpdate(_ context.Context, _, m *AROControlPlane) (admission.Warnings, error) {
	return nil, m.Validate(mw.Client)
}

// ValidateDelete implements webhook.Validator so a webhook will be registered for the type.
func (mw *aroControlPlaneWebhook) ValidateDelete(_ context.Context, _ *AROControlPlane) (admission.Warnings, error) {
	return nil, nil
}
