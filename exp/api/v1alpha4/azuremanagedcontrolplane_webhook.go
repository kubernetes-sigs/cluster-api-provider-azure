...
// +kubebuilder:webhook:path=/mutate-exp-infrastructure-cluster-x-k8s-io-v1alpha4-azuremanagedcontrolplane,mutating=true,failurePolicy=fail,groups=exp.infrastructure.cluster.x-k8s.io,resources=azuremanagedcontrolplanes,verbs=create;update,versions=v1alpha4,name=azuremanagedcontrolplane.kb.io,sideEffects=None,admissionReviewVersions=v1beta1
...
// +kubebuilder:webhook:verbs=create;update,path=/validate-exp-infrastructure-cluster-x-k8s-io-v1alpha4-azuremanagedcontrolplane,mutating=false,failurePolicy=fail,groups=exp.infrastructure.cluster.x-k8s.io,resources=azuremanagedcontrolplanes,versions=v1alpha4,name=azuremanagedcontrolplane.kb.io,sideEffects=None,admissionReviewVersions=v1beta1
