...
func SetupAROMachinePoolWebhookWithManager(mgr ctrl.Manager) error {
	...
	return ctrl.NewWebhookManagedBy(mgr, &AROMachinePool{}).
		WithDefaulter(mw).
		WithValidator(mw).
		Complete()
}
...
func (mw *aroMachinePoolWebhook) Default(_ context.Context, _ *AROMachinePool) error {
	return nil
}
...
func (mw *aroMachinePoolWebhook) ValidateCreate(_ context.Context, m *AROMachinePool) (admission.Warnings, error) {
...
func (mw *aroMachinePoolWebhook) ValidateUpdate(_ context.Context, _, m *AROMachinePool) (admission.Warnings, error) {
	return nil, m.Validate(mw.Client)
}

// ValidateDelete implements webhook.Validator so a webhook will be registered for the type.
func (mw *aroMachinePoolWebhook) ValidateDelete(_ context.Context, m *AROMachinePool) (admission.Warnings, error) {
