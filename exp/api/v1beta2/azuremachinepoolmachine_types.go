...
type (
	...
	AzureMachinePoolMachineStatus struct {
		...
		// NOTE: Fields in this struct are part of the Cluster API contract and are used to orchestrate initial Machine Pool Machine provisioning.
		// +optional
		...
		// +optional
		Deprecated *AzureMachinePoolMachineDeprecatedStatus `json:"deprecated,omitempty"`
	}
	...
	// AzureMachinePoolMachineDeprecatedStatus groups all the status fields that are deprecated and will be removed in a future version.
	AzureMachinePoolMachineDeprecatedStatus struct {
		// v1beta1 groups all the status fields that are deprecated and will be removed when support for v1beta1 will be dropped.
		// +optional
		V1Beta1 *AzureMachinePoolMachineV1Beta1DeprecatedStatus `json:"v1beta1,omitempty"`
	}

	// AzureMachinePoolMachineV1Beta1DeprecatedStatus groups all the status fields that are deprecated and will be removed when support for v1beta1 will be dropped.
	AzureMachinePoolMachineV1Beta1DeprecatedStatus struct {
		...
		// conditions defines current service state of the AzureMachinePoolMachine.
		//
		// Deprecated: This field is deprecated and is going to be removed when support for v1beta1 will be dropped.
		//
		// +optional
...
// GetConditions returns the list of conditions for an AzureMachinePoolMachine API object.
func (ampm *AzureMachinePoolMachine) GetConditions() []metav1.Condition {
	return ampm.Status.Conditions
}

// SetConditions will set the given conditions on an AzureMachinePoolMachine object.
func (ampm *AzureMachinePoolMachine) SetConditions(conditions []metav1.Condition) {
...
func (ampm *AzureMachinePoolMachine) GetV1Beta1Conditions() clusterv1beta1.Conditions {
	if ampm.Status.Deprecated == nil || ampm.Status.Deprecated.V1Beta1 == nil {
		return nil
	}
	return ampm.Status.Deprecated.V1Beta1.Conditions
}

// SetV1Beta1Conditions sets the v1beta1 conditions on an AzureMachinePoolMachine object.
func (ampm *AzureMachinePoolMachine) SetV1Beta1Conditions(conditions clusterv1beta1.Conditions) {
	if ampm.Status.Deprecated == nil {
		ampm.Status.Deprecated = &AzureMachinePoolMachineDeprecatedStatus{}
	}
	if ampm.Status.Deprecated.V1Beta1 == nil {
		ampm.Status.Deprecated.V1Beta1 = &AzureMachinePoolMachineV1Beta1DeprecatedStatus{}
	}
	ampm.Status.Deprecated.V1Beta1.Conditions = conditions
}
