...
type (
	...
	AzureMachinePoolStatus struct {
		// conditions represents the observations of an AzureMachinePool's current state.
		// +optional
		// +listType=map
		// +listMapKey=type
		...
		// initialization provides observations of the AzureMachinePool initialization process.
		// NOTE: Fields in this struct are part of the Cluster API contract and are used to orchestrate initial Machine Pool provisioning.
		// +optional
		Initialization AzureMachinePoolInitializationStatus `json:"initialization,omitempty"`
		...
		// +optional
		Deprecated *AzureMachinePoolDeprecatedStatus `json:"deprecated,omitempty"`
	}
	...
	// AzureMachinePoolDeprecatedStatus groups all the status fields that are deprecated and will be removed in a future version.
	AzureMachinePoolDeprecatedStatus struct {
		// v1beta1 groups all the status fields that are deprecated and will be removed when support for v1beta1 will be dropped.
		// +optional
		V1Beta1 *AzureMachinePoolV1Beta1DeprecatedStatus `json:"v1beta1,omitempty"`
	}

	// AzureMachinePoolV1Beta1DeprecatedStatus groups all the status fields that are deprecated and will be removed when support for v1beta1 will be dropped.
	AzureMachinePoolV1Beta1DeprecatedStatus struct {
...
func (amp *AzureMachinePool) GetConditions() []metav1.Condition {
	return amp.Status.Conditions
}

// SetConditions will set the given conditions on an AzureMachinePool object.
func (amp *AzureMachinePool) SetConditions(conditions []metav1.Condition) {
	amp.Status.Conditions = conditions
}

// GetV1Beta1Conditions returns the v1beta1 conditions for an AzureMachinePool API object.
func (amp *AzureMachinePool) GetV1Beta1Conditions() clusterv1beta1.Conditions {
	if amp.Status.Deprecated == nil || amp.Status.Deprecated.V1Beta1 == nil {
		return nil
	}
	return amp.Status.Deprecated.V1Beta1.Conditions
}

// SetV1Beta1Conditions sets the v1beta1 conditions on an AzureMachinePool object.
func (amp *AzureMachinePool) SetV1Beta1Conditions(conditions clusterv1beta1.Conditions) {
	if amp.Status.Deprecated == nil {
		amp.Status.Deprecated = &AzureMachinePoolDeprecatedStatus{}
	}
	if amp.Status.Deprecated.V1Beta1 == nil {
		amp.Status.Deprecated.V1Beta1 = &AzureMachinePoolV1Beta1DeprecatedStatus{}
	}
	amp.Status.Deprecated.V1Beta1.Conditions = conditions
}
