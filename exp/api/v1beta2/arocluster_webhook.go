...
var _ admission.Validator[*AROCluster] = &aroClusterWebhook{}

// ValidateCreate implements webhook.CustomValidator so a webhook will be registered for the type.
func (r *aroClusterWebhook) ValidateCreate(_ context.Context, _ *AROCluster) (admission.Warnings, error) {
	return nil, nil
}

// ValidateUpdate implements webhook.CustomValidator so a webhook will be registered for the type.
func (r *aroClusterWebhook) ValidateUpdate(_ context.Context, _, _ *AROCluster) (admission.Warnings, error) {
	return nil, nil
}

// ValidateDelete implements webhook.CustomValidator so a webhook will be registered for the type.
func (r *aroClusterWebhook) ValidateDelete(_ context.Context, _ *AROCluster) (admission.Warnings, error) {
	return nil, nil
}
