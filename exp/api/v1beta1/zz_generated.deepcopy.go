...
func (in *AzureMachinePoolMachineStatus) DeepCopyInto(out *AzureMachinePoolMachineStatus) {
	*out = *in
	...
	if in.V1Beta2 != nil {
		...
		*out = new(AzureMachinePoolMachineV1Beta2Status)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AzureMachinePoolMachineV1Beta2Status) DeepCopyInto(out *AzureMachinePoolMachineV1Beta2Status) {
	*out = *in
	if in.Conditions != nil {
		in, out := &in.Conditions, &out.Conditions
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AzureMachinePoolMachineV1Beta2Status.
func (in *AzureMachinePoolMachineV1Beta2Status) DeepCopy() *AzureMachinePoolMachineV1Beta2Status {
	if in == nil {
		return nil
	}
	out := new(AzureMachinePoolMachineV1Beta2Status)
...
func (in *AzureMachinePoolStatus) DeepCopyInto(out *AzureMachinePoolStatus) {
	*out = *in
	...
	if in.V1Beta2 != nil {
		in, out := &in.V1Beta2, &out.V1Beta2
		*out = new(AzureMachinePoolV1Beta2Status)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AzureMachinePoolV1Beta2Status) DeepCopyInto(out *AzureMachinePoolV1Beta2Status) {
	*out = *in
	if in.Conditions != nil {
		in, out := &in.Conditions, &out.Conditions
		*out = make([]v1.Condition, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AzureMachinePoolV1Beta2Status.
func (in *AzureMachinePoolV1Beta2Status) DeepCopy() *AzureMachinePoolV1Beta2Status {
	if in == nil {
		return nil
	}
	out := new(AzureMachinePoolV1Beta2Status)
