...
func (in *AzureDefaultingImage) DeepCopyInto(out *AzureDefaultingImage) {
	*out = *in
	if in.Image != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AzureDefaultingImage.
func (in *AzureDefaultingImage) DeepCopy() *AzureDefaultingImage {
	if in == nil {
		return nil
	}
	out := new(AzureDefaultingImage)
	in.DeepCopyInto(out)
	return out
}
