...
func (m *MockTagScope) APIServerLBName() string {
	m.ctrl.T.Helper()
...
func (mr *MockTagScopeMockRecorder) APIServerLBName() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "APIServerLBName", reflect.TypeOf((*MockTagScope)(nil).APIServerLBName))
}

// NodeOutboundLBName mocks base method.
func (m *MockTagScope) NodeOutboundLBName() string {
	m.ctrl.T.Helper()
...
func (mr *MockTagScopeMockRecorder) NodeOutboundLBName() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "NodeOutboundLBName", reflect.TypeOf((*MockTagScope)(nil).NodeOutboundLBName))
}
