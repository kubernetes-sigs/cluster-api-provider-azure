...
func (m *MockScaleSetScope) NodeOutboundLBName() string {
	m.ctrl.T.Helper()
...
func (mr *MockScaleSetScopeMockRecorder) NodeOutboundLBName() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "NodeOutboundLBName", reflect.TypeOf((*MockScaleSetScope)(nil).NodeOutboundLBName))
}
