...
func (m *MockVMScope) APIServerLBName() string {
	m.ctrl.T.Helper()
...
func (mr *MockVMScopeMockRecorder) APIServerLBName() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "APIServerLBName", reflect.TypeOf((*MockVMScope)(nil).APIServerLBName))
}

// NodeOutboundLBName mocks base method.
func (m *MockVMScope) NodeOutboundLBName() string {
	m.ctrl.T.Helper()
...
func (mr *MockVMScopeMockRecorder) NodeOutboundLBName() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "NodeOutboundLBName", reflect.TypeOf((*MockVMScope)(nil).NodeOutboundLBName))
}
