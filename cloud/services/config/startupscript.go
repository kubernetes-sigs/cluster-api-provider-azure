...
func GetVMStartupScript(machine *scope.MachineScope, bootstrapToken string) (string, error) {
...
func getAzureCloudProviderConfig(machine *scope.MachineScope) string {
	return fmt.Sprintf(`{
