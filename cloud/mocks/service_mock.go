...
func (m *MockClusterDescriber) NodeRouteTable() *v1alpha3.RouteTable {
	m.ctrl.T.Helper()
...
func (mr *MockClusterDescriberMockRecorder) NodeRouteTable() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "NodeRouteTable", reflect.TypeOf((*MockClusterDescriber)(nil).NodeRouteTable))
}

// ControlPlaneRouteTable mocks base method.
func (m *MockClusterDescriber) ControlPlaneRouteTable() *v1alpha3.RouteTable {
	m.ctrl.T.Helper()
...
func (mr *MockClusterDescriberMockRecorder) ControlPlaneRouteTable() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ControlPlaneRouteTable", reflect.TypeOf((*MockClusterDescriber)(nil).ControlPlaneRouteTable))
}
