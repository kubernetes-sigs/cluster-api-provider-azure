...
| `RUN_CAPI_E2E`             | Runs the core cluster-api E2E test suite. Requires having the cluster-api repository cloned locally at `${GOPATH}/src/sigs.k8s.io/cluster-api` | `false`                                                               |
| `RUN_CAPZ_E2E`             | Runs this repo's E2E test suite.                                                                                                               | `true`                                                                |
