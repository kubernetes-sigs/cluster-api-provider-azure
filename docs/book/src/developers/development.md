...
| `KUBECONFIG`                | Provide your existing cluster kubeconfig filepath. If no kubeconfig is provided, `./$CLUSTER_NAME.kubeconfig` will be used, where `$CLUSTER_NAME` is the name of your cluster identified by the value of that environment variable.                                                                                                                                                                                                                                                                                                                                                                                                                      |
