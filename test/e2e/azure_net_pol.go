...
func AzureNetPolSpec(ctx context.Context, inputGetter func() AzureNetPolSpecInput) {
	...
	frontEndProd := deploymentBuilder.Create("library/nginx:latest", frontendProdDeploymentName, namespaceProd.GetName())
	...
	frontEndDev := deploymentBuilder.Create("library/nginx:latest", frontendDevDeploymentName, namespaceDev.GetName())
	...
	backendDev := deploymentBuilder.Create("library/nginx:latest", backendDeploymentName, namespaceDev.GetName())
	...
	nwpolicy := deploymentBuilder.Create("library/nginx:latest", nwpolicyDeploymentName, namespaceDev.GetName())
