...
// the given ClusterProxy. OCI charts are pulled directly by reference and have no repository to
// add, so this is a sibling of InstallHelmChart rather than an option on it.
