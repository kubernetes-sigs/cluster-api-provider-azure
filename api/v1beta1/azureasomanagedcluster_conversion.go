...
func (src *AzureASOManagedCluster) ConvertTo(dstRaw conversion.Hub) error {
	...
	if err := Convert_v1beta1_AzureASOManagedCluster_To_v1beta2_AzureASOManagedCluster(src, dst, nil); err != nil {
		return err
	}
...
func (dst *AzureASOManagedCluster) ConvertFrom(srcRaw conversion.Hub) error {
	...
	if err := Convert_v1beta2_AzureASOManagedCluster_To_v1beta1_AzureASOManagedCluster(src, dst, nil); err != nil {
		return err
	}
