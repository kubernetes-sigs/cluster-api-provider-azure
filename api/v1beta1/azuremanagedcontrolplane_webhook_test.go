	...
	tests := []struct {
	...
	}{
		{
			...
			amcp: AzureManagedControlPlane{
				...
				Spec: AzureManagedControlPlaneSpec{
					DNSServiceIP: pointer.String("192.168.0.10"),
					Version:      "v1.17.8",
				},
			},
			expectErr: false,
		},
		{
			...
			amcp: AzureManagedControlPlane{
				ObjectMeta: getAMCPMetaData(),
				Spec: AzureManagedControlPlaneSpec{
					DNSServiceIP: pointer.String("192.168.0.10.3"),
					Version:      "v1.17.8",
				},
			},
			expectErr: true,
		},
		{
			...
			amcp: AzureManagedControlPlane{
				ObjectMeta: getAMCPMetaData(),
				Spec: AzureManagedControlPlaneSpec{
					DNSServiceIP: pointer.String("192.168.0.11"),
					Version:      "v1.17.8",
				},
			},
			expectErr: true,
...
func TestAzureManagedControlPlane_ValidateUpdate(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			amcp: &AzureManagedControlPlane{
				Spec: AzureManagedControlPlaneSpec{
					DNSServiceIP: pointer.String("192.168.1.1"),
					Version:      "v1.18.0",
				},
			},
			wantErr: true,
