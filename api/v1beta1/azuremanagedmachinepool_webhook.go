...
func validateMaxPods(maxPods *int32, fldPath *field.Path) error {
	if maxPods != nil {
		if ptr.Deref[int32](maxPods, 0) < 10 || ptr.Deref[int32](maxPods, 0) > 250 {
...
func validateMachinePoolSubnetName(subnetName *string, fldPath *field.Path) error {
	if subnetName != nil {
...
func validateKubeletConfig(kubeletConfig *KubeletConfig, fldPath *field.Path) error {
	...
	if kubeletConfig != nil {
		...
		if kubeletConfig.ImageGcHighThreshold != nil && kubeletConfig.ImageGcLowThreshold != nil {
			if ptr.Deref[int32](kubeletConfig.ImageGcLowThreshold, 0) > ptr.Deref[int32](kubeletConfig.ImageGcHighThreshold, 0) {
				return field.Invalid(
					...
					fmt.Sprintf("must not be greater than ImageGcHighThreshold, ImageGcLowThreshold=%d, ImageGcHighThreshold=%d",
						ptr.Deref[int32](kubeletConfig.ImageGcLowThreshold, 0), ptr.Deref[int32](kubeletConfig.ImageGcHighThreshold, 0)))
			}
		}
