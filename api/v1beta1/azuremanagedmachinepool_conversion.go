...
func (src *AzureManagedMachinePool) ConvertTo(dstRaw conversion.Hub) error {
	...
	if err := Convert_v1beta1_AzureManagedMachinePool_To_v1beta2_AzureManagedMachinePool(src, dst, nil); err != nil {
		return err
	}
...
func (dst *AzureManagedMachinePool) ConvertFrom(srcRaw conversion.Hub) error {
	...
	if err := Convert_v1beta2_AzureManagedMachinePool_To_v1beta1_AzureManagedMachinePool(src, dst, nil); err != nil {
		return err
	}
