...
func (src *AzureASOManagedControlPlaneTemplate) ConvertTo(dstRaw conversion.Hub) error {
	...
	return Convert_v1beta1_AzureASOManagedControlPlaneTemplate_To_v1beta2_AzureASOManagedControlPlaneTemplate(src, dst, nil)
}
...
func (dst *AzureASOManagedControlPlaneTemplate) ConvertFrom(srcRaw conversion.Hub) error {
	...
	return Convert_v1beta2_AzureASOManagedControlPlaneTemplate_To_v1beta1_AzureASOManagedControlPlaneTemplate(src, dst, nil)
}
...
func (src *AzureASOManagedControlPlaneTemplateList) ConvertTo(dstRaw conversion.Hub) error {
	...
	return Convert_v1beta1_AzureASOManagedControlPlaneTemplateList_To_v1beta2_AzureASOManagedControlPlaneTemplateList(src, dst, nil)
}
...
func (dst *AzureASOManagedControlPlaneTemplateList) ConvertFrom(srcRaw conversion.Hub) error {
	...
	return Convert_v1beta2_AzureASOManagedControlPlaneTemplateList_To_v1beta1_AzureASOManagedControlPlaneTemplateList(src, dst, nil)
}
