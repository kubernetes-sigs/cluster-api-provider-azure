...
func (src *AzureASOManagedMachinePoolTemplate) ConvertTo(dstRaw conversion.Hub) error {
	...
	return Convert_v1beta1_AzureASOManagedMachinePoolTemplate_To_v1beta2_AzureASOManagedMachinePoolTemplate(src, dst, nil)
}
...
func (dst *AzureASOManagedMachinePoolTemplate) ConvertFrom(srcRaw conversion.Hub) error {
	...
	return Convert_v1beta2_AzureASOManagedMachinePoolTemplate_To_v1beta1_AzureASOManagedMachinePoolTemplate(src, dst, nil)
}
...
func (src *AzureASOManagedMachinePoolTemplateList) ConvertTo(dstRaw conversion.Hub) error {
	...
	return Convert_v1beta1_AzureASOManagedMachinePoolTemplateList_To_v1beta2_AzureASOManagedMachinePoolTemplateList(src, dst, nil)
}
...
func (dst *AzureASOManagedMachinePoolTemplateList) ConvertFrom(srcRaw conversion.Hub) error {
	...
	return Convert_v1beta2_AzureASOManagedMachinePoolTemplateList_To_v1beta1_AzureASOManagedMachinePoolTemplateList(src, dst, nil)
}
