...
func (src *AzureASOManagedCluster) ConvertTo(dstRaw conversion.Hub) error {
	...
	if err := Convert_v1alpha1_AzureASOManagedCluster_To_v1beta2_AzureASOManagedCluster(src, dst, nil); err != nil {
		return err
	}

	restored := &infrav1.AzureASOManagedCluster{}
...
func (dst *AzureASOManagedCluster) ConvertFrom(srcRaw conversion.Hub) error {
	...
	if err := Convert_v1beta2_AzureASOManagedCluster_To_v1alpha1_AzureASOManagedCluster(src, dst, nil); err != nil {
		return err
	}
