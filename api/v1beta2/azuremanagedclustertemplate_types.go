...
// +kubebuilder:deprecatedversion:warning="AzureManagedClusterTemplate and the AzureManaged API are deprecated. Please migrate to infrastructure.cluster.x-k8s.io/v1beta2 AzureASOManagedClusterTemplate and related AzureASOManaged resources instead."
