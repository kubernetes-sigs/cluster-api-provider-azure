...
// +kubebuilder:deprecatedversion:warning="AzureManagedMachinePoolTemplate and the AzureManaged API are deprecated. Please migrate to infrastructure.cluster.x-k8s.io/v1beta2 AzureASOManagedMachinePoolTemplate and related AzureASOManaged resources instead."
...
// AzureManagedMachinePoolTemplateResource describes the data needed to create an AzureManagedMachinePool from a template.
