...
// +kubebuilder:deprecatedversion:warning="AzureManagedControlPlaneTemplate and the AzureManaged API are deprecated. Please migrate to infrastructure.cluster.x-k8s.io/v1beta2 AzureASOManagedControlPlaneTemplate and related AzureASOManaged resources instead."
...
// AzureManagedControlPlaneTemplateResource describes the data needed to create an AzureManagedControlPlane from a template.
