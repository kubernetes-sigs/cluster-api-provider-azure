...
type AzureMachineStatus struct {
	...
	// +optional
	Deprecated *AzureMachineDeprecatedStatus `json:"deprecated,omitempty"`
}
...
type AzureMachineInitializationStatus struct {
	// provisioned is true when the infrastructure provider reports that the AzureMachine's infrastructure is fully provisioned.
...
// AzureMachineDeprecatedStatus groups all the status fields that are deprecated and will be removed in a future version.
type AzureMachineDeprecatedStatus struct {
	// v1beta1 groups all the status fields that are deprecated and will be removed when support for v1beta1 will be dropped.
	// +optional
	V1Beta1 *AzureMachineV1Beta1DeprecatedStatus `json:"v1beta1,omitempty"`
}

// AzureMachineV1Beta1DeprecatedStatus groups all the status fields that are deprecated and will be removed when support for v1beta1 will be dropped.
type AzureMachineV1Beta1DeprecatedStatus struct {
...
func (m *AzureMachine) GetConditions() []metav1.Condition {
	return m.Status.Conditions
}

// SetConditions will set the given conditions on an AzureMachine object.
func (m *AzureMachine) SetConditions(conditions []metav1.Condition) {
	m.Status.Conditions = conditions
}

// GetV1Beta1Conditions returns the v1beta1 conditions for an AzureMachine API object.
func (m *AzureMachine) GetV1Beta1Conditions() clusterv1beta1.Conditions {
...
func (m *AzureMachine) SetV1Beta1Conditions(conditions clusterv1beta1.Conditions) {
	if m.Status.Deprecated == nil {
		m.Status.Deprecated = &AzureMachineDeprecatedStatus{}
	}
	if m.Status.Deprecated.V1Beta1 == nil {
		m.Status.Deprecated.V1Beta1 = &AzureMachineV1Beta1DeprecatedStatus{}
	}
