...
type AzureManagedMachinePoolStatus struct {
	...
	// +optional
	Deprecated *AzureManagedMachinePoolDeprecatedStatus `json:"deprecated,omitempty"`
}
...
type AzureManagedMachinePoolInitializationStatus struct {
	// provisioned is true when the infrastructure provider reports that the AzureManagedMachinePool's infrastructure is fully provisioned.
...
// AzureManagedMachinePoolDeprecatedStatus groups all the status fields that are deprecated and will be removed in a future version.
type AzureManagedMachinePoolDeprecatedStatus struct {
	// v1beta1 groups all the status fields that are deprecated and will be removed when support for v1beta1 will be dropped.
	// +optional
	V1Beta1 *AzureManagedMachinePoolV1Beta1DeprecatedStatus `json:"v1beta1,omitempty"`
}

// AzureManagedMachinePoolV1Beta1DeprecatedStatus groups all the status fields that are deprecated and will be removed when support for v1beta1 will be dropped.
type AzureManagedMachinePoolV1Beta1DeprecatedStatus struct {
	...
	// errorReason will be set in the event that there is a terminal problem reconciling the MachinePool
	...
	// errorMessage will be set in the event that there is a terminal problem reconciling the MachinePool
...
// +kubebuilder:deprecatedversion:warning="AzureManagedMachinePool and the AzureManaged API are deprecated. Please migrate to infrastructure.cluster.x-k8s.io/v1beta2 AzureASOManagedMachinePool and related AzureASOManaged resources instead."
...
func (m *AzureManagedMachinePool) GetConditions() []metav1.Condition {
	return m.Status.Conditions
}

// SetConditions will set the given conditions on an AzureManagedMachinePool object.
func (m *AzureManagedMachinePool) SetConditions(conditions []metav1.Condition) {
	m.Status.Conditions = conditions
}

// GetV1Beta1Conditions returns the v1beta1 conditions for an AzureManagedMachinePool API object.
func (m *AzureManagedMachinePool) GetV1Beta1Conditions() clusterv1beta1.Conditions {
...
func (m *AzureManagedMachinePool) SetV1Beta1Conditions(conditions clusterv1beta1.Conditions) {
	if m.Status.Deprecated == nil {
		m.Status.Deprecated = &AzureManagedMachinePoolDeprecatedStatus{}
	}
	if m.Status.Deprecated.V1Beta1 == nil {
		m.Status.Deprecated.V1Beta1 = &AzureManagedMachinePoolV1Beta1DeprecatedStatus{}
	}
