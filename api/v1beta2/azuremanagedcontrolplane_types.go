...
type AzureManagedControlPlaneStatus struct {
	...
	// +optional
	Initialization AzureManagedControlPlaneInitializationStatus `json:"initialization,omitempty,omitzero"`
	...
	// +optional
	Deprecated *AzureManagedControlPlaneDeprecatedStatus `json:"deprecated,omitempty"`
}
...
type AzureManagedControlPlaneInitializationStatus struct {
	// provisioned is true when the infrastructure provider reports that the AzureManagedControlPlane's infrastructure is fully provisioned.
...
// AzureManagedControlPlaneDeprecatedStatus groups all the status fields that are deprecated and will be removed in a future version.
type AzureManagedControlPlaneDeprecatedStatus struct {
	// v1beta1 groups all the status fields that are deprecated and will be removed when support for v1beta1 will be dropped.
	// +optional
	V1Beta1 *AzureManagedControlPlaneV1Beta1DeprecatedStatus `json:"v1beta1,omitempty"`
}

// AzureManagedControlPlaneV1Beta1DeprecatedStatus groups all the status fields that are deprecated and will be removed when support for v1beta1 will be dropped.
type AzureManagedControlPlaneV1Beta1DeprecatedStatus struct {
...
// +kubebuilder:deprecatedversion:warning="AzureManagedControlPlane and the AzureManaged API are deprecated. Please migrate to infrastructure.cluster.x-k8s.io/v1beta2 AzureASOManagedControlPlane and related AzureASOManaged resources instead."
...
func (m *AzureManagedControlPlane) GetConditions() []metav1.Condition {
	return m.Status.Conditions
}

// SetConditions will set the given conditions on an AzureManagedControlPlane object.
func (m *AzureManagedControlPlane) SetConditions(conditions []metav1.Condition) {
	m.Status.Conditions = conditions
}

// GetV1Beta1Conditions returns the v1beta1 conditions for an AzureManagedControlPlane API object.
//
//nolint:staticcheck // Intentionally using deprecated field for v1beta1 backward compat
func (m *AzureManagedControlPlane) GetV1Beta1Conditions() clusterv1.Conditions {
...
// SetV1Beta1Conditions sets the v1beta1 conditions on an AzureManagedControlPlane object.
//
//nolint:staticcheck // Intentionally using deprecated field for v1beta1 backward compat
func (m *AzureManagedControlPlane) SetV1Beta1Conditions(conditions clusterv1.Conditions) {
	if m.Status.Deprecated == nil {
		m.Status.Deprecated = &AzureManagedControlPlaneDeprecatedStatus{}
	}
	if m.Status.Deprecated.V1Beta1 == nil {
		m.Status.Deprecated.V1Beta1 = &AzureManagedControlPlaneV1Beta1DeprecatedStatus{}
	}
