...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddConversionFunc((*runtime.RawExtension)(nil), (*Image)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_runtime_RawExtension_To_v1alpha2_Image(a.(*runtime.RawExtension), b.(*Image), scope)
	}); err != nil {
		return err
	}
	...
	if err := s.AddConversionFunc((*Image)(nil), (*runtime.RawExtension)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha2_Image_To_runtime_RawExtension(a.(*Image), b.(*runtime.RawExtension), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha2_AzureMachineSpec_To_v1alpha3_AzureMachineSpec(in *AzureMachineSpec, out *v1alpha3.AzureMachineSpec, s conversion.Scope) error {
	...
	if in.Image != nil {
		...
		*out = new(runtime.RawExtension)
		if err := Convert_v1alpha2_Image_To_runtime_RawExtension(*in, *out, s); err != nil {
			return err
		}
	} else {
		out.Image = nil
...
func autoConvert_v1alpha3_AzureMachineSpec_To_v1alpha2_AzureMachineSpec(in *v1alpha3.AzureMachineSpec, out *AzureMachineSpec, s conversion.Scope) error {
	...
	if in.Image != nil {
		in, out := &in.Image, &out.Image
		*out = new(Image)
		if err := Convert_runtime_RawExtension_To_v1alpha2_Image(*in, *out, s); err != nil {
			return err
		}
	} else {
		out.Image = nil
...
func autoConvert_v1alpha2_VM_To_v1alpha3_VM(in *VM, out *v1alpha3.VM, s conversion.Scope) error {
	...
	out.VMSize = in.VMSize
	if err := Convert_v1alpha2_Image_To_runtime_RawExtension(&in.Image, &out.Image, s); err != nil {
		return err
	}
	if err := Convert_v1alpha2_OSDisk_To_v1alpha3_OSDisk(&in.OSDisk, &out.OSDisk, s); err != nil {
		return err
...
func autoConvert_v1alpha3_VM_To_v1alpha2_VM(in *v1alpha3.VM, out *VM, s conversion.Scope) error {
	...
	out.AvailabilityZone = in.AvailabilityZone
	out.VMSize = in.VMSize
	if err := Convert_runtime_RawExtension_To_v1alpha2_Image(&in.Image, &out.Image, s); err != nil {
		return err
	}
	if err := Convert_v1alpha3_OSDisk_To_v1alpha2_OSDisk(&in.OSDisk, &out.OSDisk, s); err != nil {
		return err
