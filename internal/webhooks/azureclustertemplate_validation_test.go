...
func TestValidateAPIServerLBTemplate(t *testing.T) {
	...
	for _, c := range cases {
		...
		t.Run(tc.name, func(t *testing.T) {
			t.Parallel()
			g := NewWithT(t)
			res := validateAzureClusterTemplateAPIServerLB(tc.clusterTemplate,
...
func TestControlPlaneOutboundLBTemplate(t *testing.T) {
	...
	for _, c := range cases {
		...
		t.Run(tc.name, func(t *testing.T) {
			t.Parallel()
			g := NewWithT(t)
			res := validateAzureClusterTemplateControlPlaneOutboundLB(tc.clusterTemplate)
...
func TestNodeOutboundLBTemplate(t *testing.T) {
	...
	for _, c := range cases {
		...
		t.Run(tc.name, func(t *testing.T) {
			t.Parallel()
			g := NewWithT(t)
			res := validateAzureClusterTemplateNodeOutboundLB(tc.clusterTemplate)
...
func TestValidatePrivateDNSZoneName(t *testing.T) {
	...
	for _, c := range cases {
		...
		t.Run(tc.name, func(t *testing.T) {
			t.Parallel()
			g := NewWithT(t)
			res := validateAzureClusterTemplatePrivateDNSZoneName(tc.clusterTemplate)
...
func TestValidatePrivateDNSZoneResourceGroup(t *testing.T) {
	...
	for _, c := range cases {
		...
		t.Run(tc.name, func(t *testing.T) {
			t.Parallel()
			g := NewWithT(t)
			res := validateAzureClusterTemplatePrivateDNSZoneResourceGroup(tc.clusterTemplate)
...
func TestValidateNetworkSpec(t *testing.T) {
	...
	for _, c := range cases {
		...
		t.Run(tc.name, func(t *testing.T) {
			t.Parallel()
			g := NewWithT(t)
			res := validateAzureClusterTemplateNetworkSpec(tc.clusterTemplate)
			if tc.expectValid {
				g.Expect(res).To(BeNil())
			} else {
				g.Expect(res).NotTo(BeNil())
