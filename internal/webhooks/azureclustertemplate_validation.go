...
func validateAzureClusterTemplateSpec(c *AzureClusterTemplate) field.ErrorList {
	...
	allErrs = append(allErrs, validateAzureClusterTemplateAPIServerLB(c,
		field.NewPath("spec").Child("template").Child("spec").Child("networkSpec").Child("apiServerLB"),
	)...)

	allErrs = append(allErrs, validateAzureClusterTemplateNetworkSpec(c)...)

	allErrs = append(allErrs, validateAzureClusterTemplateControlPlaneOutboundLB(c)...)

	allErrs = append(allErrs, validateAzureClusterTemplatePrivateDNSZoneName(c)...)

	allErrs = append(allErrs, validateAzureClusterTemplatePrivateDNSZoneResourceGroup(c)...)
...
func validateAzureClusterTemplateNetworkSpec(c *AzureClusterTemplate) field.ErrorList {
	...
	if needOutboundLB {
		allErrs = append(allErrs, validateAzureClusterTemplateNodeOutboundLB(c)...)
	}
