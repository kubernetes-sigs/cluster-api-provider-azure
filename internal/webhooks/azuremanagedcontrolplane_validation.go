...
func validateAzureManagedControlPlane(m *AzureManagedControlPlane, cli client.Client) error {
	...
	validators := []func(m *AzureManagedControlPlane, client client.Client) field.ErrorList{
		...
		validateAzureManagedControlPlaneDNSPrefix,
		validateAzureManagedControlPlaneDisableLocalAccounts,
	}
	for _, validator := range validators {
		if err := validator(m, cli); err != nil {
	...
	allErrs = append(allErrs, validateAzureManagedControlPlaneClassSpecSecurityProfile(&m.Spec.AzureManagedControlPlaneClassSpec)...)
...
func validateAzureManagedControlPlaneClassSpecSecurityProfile(m *AzureManagedControlPlaneClassSpec) field.ErrorList {
	...
	if err := validateAzureManagedControlPlaneClassSpecWorkloadIdentity(m); err != nil {
		allErrs = append(allErrs, err...)
	}
	return allErrs
}
...
func validateAzureManagedControlPlaneClassSpecSecurityProfileUpdate(m *AzureManagedControlPlaneClassSpec, old *AzureManagedControlPlaneClassSpec) field.ErrorList {
	...
	if old.SecurityProfile != nil {
		...
		if errWorkloadIdentity := validateAzureManagedControlPlaneClassSpecWorkloadIdentityUpdate(m, old); errWorkloadIdentity != nil {
			allErrs = append(allErrs, errWorkloadIdentity...)
		}
		if errWorkloadIdentity := validateAzureManagedControlPlaneClassSpecImageCleanerUpdate(m, old); errWorkloadIdentity != nil {
			allErrs = append(allErrs, errWorkloadIdentity...)
		}
		if errWorkloadIdentity := validateAzureManagedControlPlaneClassSpecDefender(m, old); errWorkloadIdentity != nil {
			allErrs = append(allErrs, errWorkloadIdentity...)
		}
	}
	return allErrs
