...
# dependencies
* requires a build environment (make release-artifacts must work)
...
func main() {
	...
	cfg := config{
		...
		artifactDir: "out",
		artifacts: []string{
			"cluster-api-provider-azure-examples.tar",
			// TODO: Uncomment clusterazureadm once it exists
			//"clusterazureadm-darwin-amd64",
			//"clusterazureadm-linux-amd64",
...
1.
	origin is github.com/kubernetes-sigs/cluster-api-provider-azure
...
2.
	origin is github.com/myuser/cluster-api-provider-azure
	upstream is github.com/kubernetes-sigs/cluster-api-provider-azure
