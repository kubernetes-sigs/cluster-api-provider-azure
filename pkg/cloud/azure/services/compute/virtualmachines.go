...
import (
	...
	"sigs.k8s.io/cluster-api-provider-azure/pkg/cloud/azure/filter"
	"sigs.k8s.io/cluster-api-provider-azure/pkg/cloud/azure/services/awserrors"
	"sigs.k8s.io/cluster-api-provider-azure/pkg/cloud/azure/services/certificates"
	"sigs.k8s.io/cluster-api-provider-azure/pkg/cloud/azure/services/userdata"
	"sigs.k8s.io/cluster-api-provider-azure/pkg/cloud/azure/tags"
