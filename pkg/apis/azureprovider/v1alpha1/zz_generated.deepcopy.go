...
func (in AvailabilityZoneScores) DeepCopyInto(out *AvailabilityZoneScores) {
	{
		in := &in
		*out = make(AvailabilityZoneScores, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AvailabilityZoneScores.
func (in AvailabilityZoneScores) DeepCopy() AvailabilityZoneScores {
	if in == nil {
		return nil
	}
	out := new(AvailabilityZoneScores)
	in.DeepCopyInto(out)
	return *out
}
...
func (in *AzureClusterProviderStatus) DeepCopyInto(out *AzureClusterProviderStatus) {
	*out = *in
	...
	if in.ControlPlaneAvailabilityZoneScores != nil {
		in, out := &in.ControlPlaneAvailabilityZoneScores, &out.ControlPlaneAvailabilityZoneScores
		*out = make(AvailabilityZoneScores, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
