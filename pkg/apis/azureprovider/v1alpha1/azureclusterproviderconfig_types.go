...
type VnetSpec struct {
	...
	// Managed specifies if a supplied virtual network should be managed by Cluster API.
	// Defaults to "yes".
	// TODO: Move managed logic to tags once tagging is implemented.
	Managed string `json:"managed,omitempty"`
...
// IsProvided returns true if the virtual network is not managed by Cluster API.
// TODO: Check for !v.Tags.HasManaged() once tagging is implemented.
func (v *VnetSpec) IsProvided() bool {
	return v.Name != "" && strings.ToLower(v.Managed) == "no"
}
