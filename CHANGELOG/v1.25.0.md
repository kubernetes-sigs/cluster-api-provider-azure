...
Please note that upgrading CAPZ should be done one minor release at a time. Skipping ahead by more than one minor (for example, from v1.23.x to v1.25.0) is not tested and may cause problems.
...
https://github.com/kubernetes-sigs/cluster-api-provider-azure/compare/v1.24.0...v1.25.0
